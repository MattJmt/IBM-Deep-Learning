...
#                - Apply model to different iterations. Each iteration yields a new model. Calculate the cost on validation data of every model. Save the model with the lowest cost.
