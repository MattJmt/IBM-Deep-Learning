# In stochastic gradient descent we minimise one sample at a time
# PREPARATION
...
# TRAIN THE MODEL: BATCH GRADFIENT DESCENT
...
plt.plot(LOSS_BGD,label="Batch Gradient Descent")
plt.plot(LOSS_SGD,label="Stochastic Gradient Descent with DataLoader")
plt.xlabel('epoch')
plt.ylabel('Cost/ total loss')
plt.legend()
plt.show()