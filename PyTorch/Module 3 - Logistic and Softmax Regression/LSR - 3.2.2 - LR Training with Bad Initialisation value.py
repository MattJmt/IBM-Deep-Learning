# If use bad initialisation value for the PARAMETERS, then the point starts on the flat part of the 3D graph. Therefore no learn, change and accuracy is trash.
...
model.state_dict() ['linear.weight'].data[0] = torch.tensor([[-5]]) # Replace the random initialized variable values with some predetermined values that will not converge
