...
# 3) Build a Convolutional Neural Network Class
...
class CNN(nn.Module):
    ...
    def __init__(self, out_1=16, out_2=32):
        ...
        self.fc1 = nn.Linear(out_2 * 2 * 2, 10) # fully connected layer
...
# 4) Define the Convolutional Neural Network Classifier, Criterion function, Optimizer and Train the Model
