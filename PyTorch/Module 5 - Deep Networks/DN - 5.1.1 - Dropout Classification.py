...
# calculate forward step by shutting(killing) some neurons depending on a probability applied to each layer
...
# 1) Create the Model, Optimizer, and Total Loss Function
